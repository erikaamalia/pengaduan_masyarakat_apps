...
class Oracle{
    ...
    function upload_file_oracle($bucket_name, $folder_name = '', $file_name) {
        ...
        $ORACLE_NAMESPACE=env('ORACLE_NAMESPACE');
            ...
            $file_url = "https://objectstorage.ap-sydney-1.oraclecloud.com/p/8Gvsv3eMY8YYjwWNdzdHc3nUI0OViAvHXUIglurbLI0wVh27wtNxIAVVuYhrUajE/n/sd1uymztqgbu/b/pengaduan-apps/o/{$keyname}";
            try {
                $s3->putObject(array(
                    'Bucket' => $bucket_name,
                    'Key' => $keyname,
