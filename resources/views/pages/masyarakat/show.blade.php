    ...
    <div class="w-full mb-8 overflow-hidden rounded-lg shadow-xs">
      <div class="w-full overflow-x-auto">
        ...
        <div
          ...
          <h2 class="mt-4">NIK&emsp;&emsp;&emsp;&emsp;&emsp;: {{ $ite->user_nik }}</h2>
          <h2 class="mt-4">Nama&emsp;&emsp;&emsp;&emsp;: {{ $ite->name }}</h2>
          <h2 class="mt-4">No Telepon&emsp; : {{ $item->user->phone }}</h2>
          <h2 class="mt-4">Tanggal&emsp;&emsp;&emsp;: {{ $ite->created_at->format('l, d F Y - H:i:s') }}</h2>
          <h2 class="mt-4">Status&emsp;&emsp;&emsp;&ensp;:
        ...
        <div class="px-4 py-3 mb-8 flex text-gray-800 bg-white rounded-lg shadow-md dark:bg-gray-800">
          <div class="relative hidden mr-3  md:block ">
            ...
            <img class=" h-32 w-35 " width="150px" src="{{ $item->image }}" alt="" loading="lazy" />
          </div>
